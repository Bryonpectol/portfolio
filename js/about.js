import { abouts } from "../js/aboutdata.js";

const mainContainer = document.getElementById("aboutcontainer");

const allCars = abouts.map(myCar => {
  let carsYeah = abouts.find(CAR => {
